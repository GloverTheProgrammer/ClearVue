...
def classify_image(base64_image, api_key, mode):
    if mode == 0:
        ...
        print("Reading Mode")
        text_prompt = "Provide a comprehensive description of text in the image, without mentioning its a photograph or scene to the user, for a visually impaired person, focusing on text, labels, and anything that would be of use text wise within the image. Start with the 'The text contained in the image is:'. Do this within 50 words."
    elif mode == 2:
        print("Story Mode")
